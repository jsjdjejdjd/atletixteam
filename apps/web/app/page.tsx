...
const pilares = [
  { t: "FUERZA", d: "Programas por bloques con descargas, RIR, cargas y técnica controlada." },
...
const pasos = [
  ...
  { n: "04", t: "Tu entrenador te guía", d: "Corrige tus videos, ajusta tus cargas y respondé directo por el chat." },
];

const categorias = [
  {
    nombre: "Calistenia General",
    desc: "La base para volverte fuerte con tu propio peso: dominadas, fondos, core y fuerza funcional.",
    puntos: ["Programas por nivel: de principiante a élite", "Progresión de cargas y RIR", "Bloques de fuerza y descargas"],
  },
  {
    nombre: "Planche",
    desc: "El camino desde el tuck hasta el planche completo, paso a paso y con progresiones reales.",
    puntos: ["Progresiones técnicas ordenadas", "Ejercicios de sostén y transferencia", "Seguimiento por niveles de planche"],
  },
  {
    nombre: "Front Lever",
    desc: "Aprendé a controlar tu cuerpo en suspensión con la progresión que mejor se adapta a tu nivel.",
    puntos: ["Del tuck al full front lever", "Fuerza de tirón específica", "Seguimiento por niveles de front lever"],
  },
];
        ...
        <section id="categorias" className="border-t border-zinc-900 py-20">
          <div className="mx-auto w-full max-w-6xl px-6">
            <SectionTitle
              ...
              sub="Programas por categoría y por nivel: de principiante hasta élite. Vos elegís el que encaja con tu punto de partida."
            />
          ...
          <div className="mx-auto w-full max-w-3xl px-6">
            ...
            <div className="mt-10 flex flex-col gap-3">
              {[
                ...
                {
                  q: "¿Cómo me corrige el entrenador?",
                  a: "Subís un video de tu serie desde la app y tu entrenador te deja el feedback puntual sobre la técnica, además del chat directo.",
                },
                {
          ...
          <div className="mx-auto w-full max-w-6xl px-6">
            <div className="rounded-3xl border border-zinc-800 bg-zinc-900/60 p-10 text-center sm:p-16">
              <h2 className="text-3xl font-black tracking-tight text-balance sm:text-5xl">
                Tu próximo nivel empieza <span className="text-zinc-500">hoy</span>
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-zinc-400">
                Creá tu cuenta, elegí tu programa y empezá a entrenar con un plan
                y un entrenador de verdad.
              </p>
      ...
      <footer id="contacto" className="border-t border-zinc-900 py-12">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-6 px-6 text-center">
          ...
          <div className="flex flex-col items-center gap-2 text-sm text-zinc-400">
            <a
              href="mailto:gonzassjyt@gmail.com"
              className="transition hover:text-white"
            >
              gonzassjyt@gmail.com
            </a>
